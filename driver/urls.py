...
from .views import Sign_up, List_Drivers,Remove_driver,Update_password, GetDriverName
...
urlpatterns = [
    ...
    path('get_driver_name',GetDriverName.as_view({'get':'retrieve'}),name='get_driver_name')
